...
export const metadata = {
  title: 'BS English - Semester 3',
  description: 'BS English Semester 3 Documentation',
}

const banner = <Banner storageKey="nup-bs-eng-sem-3">BS English Semester 3 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS English - Semester 3</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-eng/sem-3')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-eng/sem-3" } }} />}
    >
      <div data-pagefind-filter="major: bs-eng/sem-3">
        {children}
      </div>
    </Layout>
  )
