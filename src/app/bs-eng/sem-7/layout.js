...
export const metadata = {
  title: 'BS English - Semester 7',
  description: 'BS English Semester 7 Documentation',
}

const banner = <Banner storageKey="nup-bs-eng-sem-7">BS English Semester 7 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS English - Semester 7</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-eng/sem-7')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-eng/sem-7" } }} />}
    >
      <div data-pagefind-filter="major: bs-eng/sem-7">
        {children}
      </div>
    </Layout>
  )
