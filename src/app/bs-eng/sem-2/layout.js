...
export const metadata = {
  title: 'BS English - Semester 2',
  description: 'BS English Semester 2 Documentation',
}

const banner = <Banner storageKey="nup-bs-eng-sem-2">BS English Semester 2 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS English - Semester 2</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-eng/sem-2')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-eng/sem-2" } }} />}
    >
      <div data-pagefind-filter="major: bs-eng/sem-2">
        {children}
      </div>
    </Layout>
  )
