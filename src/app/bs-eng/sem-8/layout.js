...
export const metadata = {
  title: 'BS English - Semester 8',
  description: 'BS English Semester 8 Documentation',
}

const banner = <Banner storageKey="nup-bs-eng-sem-8">BS English Semester 8 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS English - Semester 8</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-eng/sem-8')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-eng/sem-8" } }} />}
    >
      <div data-pagefind-filter="major: bs-eng/sem-8">
        {children}
      </div>
    </Layout>
  )
