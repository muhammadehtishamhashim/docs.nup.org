...
export const metadata = {
  title: 'BS English - Semester 6',
  description: 'BS English Semester 6 Documentation',
}

const banner = <Banner storageKey="nup-bs-eng-sem-6">BS English Semester 6 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS English - Semester 6</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-eng/sem-6')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-eng/sem-6" } }} />}
    >
      <div data-pagefind-filter="major: bs-eng/sem-6">
        {children}
      </div>
    </Layout>
  )
