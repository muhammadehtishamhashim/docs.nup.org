...
export const metadata = {
  title: 'BS English - Semester 4',
  description: 'BS English Semester 4 Documentation',
}

const banner = <Banner storageKey="nup-bs-eng-sem-4">BS English Semester 4 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS English - Semester 4</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-eng/sem-4')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-eng/sem-4" } }} />}
    >
      <div data-pagefind-filter="major: bs-eng/sem-4">
        {children}
      </div>
    </Layout>
  )
