...
export const metadata = {
  title: 'BS English - Semester 5',
  description: 'BS English Semester 5 Documentation',
}

const banner = <Banner storageKey="nup-bs-eng-sem-5">BS English Semester 5 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS English - Semester 5</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-eng/sem-5')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-eng/sem-5" } }} />}
    >
      <div data-pagefind-filter="major: bs-eng/sem-5">
        {children}
      </div>
    </Layout>
  )
