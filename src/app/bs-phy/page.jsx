...
import { FaAtom, FaMagnet, FaBolt, FaSatellite, FaMicroscope, FaRocket, FaRadiation, FaStar } from 'react-icons/fa';

const semesters = [
  { id: 1, name: 'Semester 1', icon: FaAtom },
  { id: 2, name: 'Semester 2', icon: FaAtom },
  { id: 3, name: 'Semester 3', icon: FaAtom },
  { id: 4, name: 'Semester 4', icon: FaAtom },
  { id: 5, name: 'Semester 5', icon: FaAtom },
  { id: 6, name: 'Semester 6', icon: FaAtom },
  { id: 7, name: 'Semester 7', icon: FaAtom },
  { id: 8, name: 'Semester 8', icon: FaAtom },
];

const activeSemesters = [];

export default function BSPhyPage() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 text-gray-900 dark:text-gray-100 p-8 font-sans">
      <div className="max-w-7xl mx-auto">
        <header className="mb-12 text-center">
          <h1 className="text-5xl font-extrabold mb-4 bg-clip-text text-transparent bg-linear-to-r from-orange-600 to-red-600 dark:from-orange-400 dark:to-red-400">
            BS Physics
          </h1>
             ...
             return (
              ...
              >
                <div className="p-8 flex flex-col items-center text-center h-full">
                  <div className={`p-4 rounded-full mb-6 ${isActive ? 'bg-orange-100 text-orange-600' : 'bg-gray-100 text-gray-400 dark:bg-gray-700 dark:text-gray-500'}`}>
                    <sem.icon size={32} />
                  </div>
                  ...
                  {isActive ? (
                    <Link href={`/bs-phy/sem-${sem.id}`} className="absolute inset-0 z-10" aria-label={`Go to ${sem.name}`} />
                  ) : (
