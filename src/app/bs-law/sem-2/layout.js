...
export const metadata = {
  title: 'BS Law - Semester 2',
  description: 'BS Law Semester 2 Documentation',
}

const banner = <Banner storageKey="nup-bs-law-sem-2">BS Law Semester 2 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Law - Semester 2</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-law/sem-2')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-law/sem-2" } }} />}
    >
      <div data-pagefind-filter="major: bs-law/sem-2">
        {children}
      </div>
    </Layout>
  )
