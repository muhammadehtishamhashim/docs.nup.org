...
export const metadata = {
  title: 'BS Law - Semester 3',
  description: 'BS Law Semester 3 Documentation',
}

const banner = <Banner storageKey="nup-bs-law-sem-3">BS Law Semester 3 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Law - Semester 3</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-law/sem-3')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-law/sem-3" } }} />}
    >
      <div data-pagefind-filter="major: bs-law/sem-3">
        {children}
      </div>
    </Layout>
  )
