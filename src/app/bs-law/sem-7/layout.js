...
export const metadata = {
  title: 'BS Law - Semester 7',
  description: 'BS Law Semester 7 Documentation',
}

const banner = <Banner storageKey="nup-bs-law-sem-7">BS Law Semester 7 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Law - Semester 7</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-law/sem-7')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-law/sem-7" } }} />}
    >
      <div data-pagefind-filter="major: bs-law/sem-7">
        {children}
      </div>
    </Layout>
  )
