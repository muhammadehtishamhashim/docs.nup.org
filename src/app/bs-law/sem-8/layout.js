...
export const metadata = {
  title: 'BS Law - Semester 8',
  description: 'BS Law Semester 8 Documentation',
}

const banner = <Banner storageKey="nup-bs-law-sem-8">BS Law Semester 8 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Law - Semester 8</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-law/sem-8')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-law/sem-8" } }} />}
    >
      <div data-pagefind-filter="major: bs-law/sem-8">
        {children}
      </div>
    </Layout>
  )
