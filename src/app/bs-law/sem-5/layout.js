...
export const metadata = {
  title: 'BS Law - Semester 5',
  description: 'BS Law Semester 5 Documentation',
}

const banner = <Banner storageKey="nup-bs-law-sem-5">BS Law Semester 5 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Law - Semester 5</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-law/sem-5')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-law/sem-5" } }} />}
    >
      <div data-pagefind-filter="major: bs-law/sem-5">
        {children}
      </div>
    </Layout>
  )
