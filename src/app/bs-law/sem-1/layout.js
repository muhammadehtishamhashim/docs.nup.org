...
export const metadata = {
  title: 'BS Law - Semester 1',
  description: 'BS Law Semester 1 Documentation',
}

const banner = <Banner storageKey="nup-bs-law-sem-1">BS Law Semester 1 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Law - Semester 1</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-law/sem-1')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-law/sem-1" } }} />}
    >
      <div data-pagefind-filter="major: bs-law/sem-1">
        {children}
      </div>
    </Layout>
  )
