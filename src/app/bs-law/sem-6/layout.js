...
export const metadata = {
  title: 'BS Law - Semester 6',
  description: 'BS Law Semester 6 Documentation',
}

const banner = <Banner storageKey="nup-bs-law-sem-6">BS Law Semester 6 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Law - Semester 6</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-law/sem-6')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-law/sem-6" } }} />}
    >
      <div data-pagefind-filter="major: bs-law/sem-6">
        {children}
      </div>
    </Layout>
  )
