...
export const metadata = {
  title: 'BS Computer Science - Semester 8',
  description: 'BS Computer Science Semester 8 Documentation',
}

const banner = <Banner storageKey="nup-bs-cs-sem-8">BS Computer Science Semester 8 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Computer Science - Semester 8</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-cs/sem-8')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-cs/sem-8" } }} />}
    >
      <div data-pagefind-filter="major: bs-cs/sem-8">
        {children}
      </div>
    </Layout>
  )
