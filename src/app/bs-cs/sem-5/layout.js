...
export const metadata = {
  title: 'BS Computer Science - Semester 5',
  description: 'BS Computer Science Semester 5 Documentation',
}

const banner = <Banner storageKey="nup-bs-cs-sem-5">BS Computer Science Semester 5 Documentation 🎓</Banner>
const navbar = (
  <Navbar
    logo={<b>NUP - BS Computer Science - Semester 5</b>}
  >
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-cs/sem-5')
  ...
  return (
    <Layout
      ...
      footer={footer}
      search={<Search searchOptions={{ filters: { major: "bs-cs/sem-5" } }} />}
    >
      <div data-pagefind-filter="major: bs-cs/sem-5">
        {children}
      </div>
    </Layout>
  )
