...
export const metadata = {
  title: 'BS Computer Science - Semester 3',
  description: 'BS Computer Science Semester 3 Documentation',
}

const banner = <Banner storageKey="nup-bs-cs-sem-3">BS Computer Science Semester 3 Documentation 🎓</Banner>
const navbar = (
  <Navbar
...
export default async function SemesterLayout({ children }) {
  ...
  const semesterItem = majorItem?.children?.find(item => item.route === '/bs-cs/sem-3')
  ...
  return (
    ...
    >
      <div data-pagefind-filter="major: bs-cs/sem-3">
        {children}
      </div>
    </Layout>
  )
